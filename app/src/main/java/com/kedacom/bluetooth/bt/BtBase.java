...
import com.kedacom.bluetooth.model.Recordtype;
...
public class BtBase {
            ...
            while (isRead) { //死循环读取
                switch (in.readInt()) {
                    ...
                    case FLAG_FILE: //读取文件
                        ...
                        notifyUI(Listener.FILE_RECEIVE_FINISH, FILE_PATH + fileName);
                        break;
    ...
    public interface Listener {
        ...
        int CONNECTED = 1;
        int MSG = 2;
        int FILE_RECEIVE_START = 3;
        int FILE_RECEIVE_FINISH = 4;
