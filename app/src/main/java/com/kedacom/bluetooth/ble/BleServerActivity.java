...
public class BleServerActivity extends Activity {
    public static UUID UUID_SERVICE = UUID.fromString("00004860-0000-1000-8000-00805f9b34fb"); //自定义UUID
    public static UUID UUID_CHAR_READ_NOTIFY = UUID.fromString("000070ff-0000-1000-8000-00805f9b34fb");
    public static UUID UUID_DESC_NOTITY = UUID.fromString("00002902-0000-1000-8000-00805f9b34fb");
    public static UUID UUID_CHAR_WRITE = UUID.fromString("000071ff-0000-1000-8000-00805f9b34fb");
